...
import { applyCollector, collectCashDonation, collectorDashboard, collectorStatus, leaderboard } from '../controllers/collector'
...
collectorRouter.post('/collect-cash', requireDonationAuth, collectCashDonation)
