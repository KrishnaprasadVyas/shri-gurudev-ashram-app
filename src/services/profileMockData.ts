...
export const donationCategoriesMock = [
  { id: 'd1', title: 'Anna Daan', amount: 'INR 45,000' },
  { id: 'd2', title: 'Temple Restoration', amount: 'INR 50,000' },
  { id: 'd3', title: 'Gau Seva', amount: 'INR 13,000' },
]
